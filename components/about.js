    ...
    return (
        <section id="about" className="bg-blackCustom text-goldCustom md:mx-20 p-10">
            ...
            <section>
                ...
                <div className="bg-greyCustom p-6 rounded-lg md:flex justify-between items-center">
                  <div className="mb-4 md:mb-0">
                    <p className="text-lg">Teaching Assistant at Seneca College</p>
                  </div>
                  <div className="text-right md:text-right">
                    <p className="text-lg">Sept 2024 - Aug 2024</p>
                  </div>
                </div>
                ...
                <div className="bg-greyCustom p-6 rounded-lg md:flex justify-between items-center">
                  <div className="mb-4 md:mb-0">
                    <p className="text-lg">Machine Operator at Hood Packaging</p>
                  </div>
                  <div className="text-right md:text-right">
                    <p className="text-lg">Jan 2025 - Apr 2026</p>
                  </div>
                </div>
            </section>
        </section>
